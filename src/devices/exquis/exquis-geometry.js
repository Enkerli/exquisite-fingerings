 ...
 * Hex grid layout, pad positions, and geometric calculations
 *
...
/**
 * Calculate grid distance between two pads (Euclidean distance approximation)
...
export function getGridDistance(row1, col1, row2, col2) {
  // Use cell centers for distance calculation
